classdef loadParameters_new < matlab.mixin.Copyable
%% loadParameters_new.m     
%
...
%%
    properties 
        ...
        beta    = 3.23;                 % mean vessel elasticity exponent [unitless]
...
%         beta                            % mean vessel elasticity exponent [unitless]
        alpha                           % Grubb's exponent [unitless]
    ...
    % ===================================================================== 
    methods
        function alpha_val = get.alpha(obj)
            alpha_val = 1/obj.beta;
        end
...
%             C_z_val = obj.k_0*obj.L/sin(obj.k_0*obj.L);
        end
